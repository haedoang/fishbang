...
<body>
	<div class="container-back"><canvas width="1400" height="600" id="fishtank">
	</div> 
	...
	<div class="wrapper_login">
		<div class="container_login">
			...
			<div class="div_button">
				<button type="button" id="login" onclick="location.href='login.jsp'">Login</button>
			</div>
			<div class="div_button">
				<button type="button" id="signup" onclick="location.href='signup.jsp'">signup</button>
			</div>
			<div class="div_button">
