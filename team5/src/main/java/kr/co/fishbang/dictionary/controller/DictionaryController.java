...
public class DictionaryController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		rd10.forward(request, response);break;
		...
		rd11.forward(request, response);break;
		...
		rd12.forward(request, response);break;
		...
		rd13.forward(request, response);break;
		...
		rd14.forward(request, response);break;
		...
		rd15.forward(request, response);break;
		...
		rd16.forward(request, response);break;
		...
		rd17.forward(request, response);break;
		...
		rd18.forward(request, response);break;
		...
		rd19.forward(request, response);break;
		...
		rd20.forward(request, response);break;
		...
		rd21.forward(request, response);break;
		...
		rd22.forward(request, response);break;
		...
		rd23.forward(request, response);break;
		...
		rd24.forward(request, response);break;
	}
}
}
