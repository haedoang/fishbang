...
<link rel="stylesheet"
	href="<c:url value="../../css/main/mainMenu.css"/>">
<link rel="stylesheet"
	...
	<div class="main-content">
		...
		<div id="mains">
			<div id="feedBoard">
				...
				<ul class="tabs group">
					<li><a class="tabOne switch activeTab" href="#">전체보기</a></li>
					<li><a class="tabTwo switch" href="#">바다고기</a></li>
					<li><a class="tabThree switch" href="#">민물고기</a></li>
