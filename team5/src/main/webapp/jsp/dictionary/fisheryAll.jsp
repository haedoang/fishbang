...
.tabs li:first-child a {
	z-index: 5 -webkit-border-top-left-radius: 8px;
	...
	<div class="main-content">
		...
		<div id="mains">
			<div id="feedBoard">
				...
				<ul class="tabs group">
					<li><a class="tabOne switch activeTab" href="#">내 어장</a></li>
					<li><a class="tabTwo switch" href="#">잡은 바다고기</a></li>
					<li><a class="tabTwo switch" href="#">잡은 민물고기</a></li>
						...
						<ul class="v">
							...
							<li class="fishinfolayout">
								<div class="fishinfoline">
									...
									<div class="fishimg">
										<img src="/team5/src/main/resources/godonga1.png" width="185"
											height="150" alt="이미지파일이어딨지?">
									</div>
									<div class="just">
										<p class="fishname1">
											고등어<br>godonga
										...
										<p class="fishviewcnt">물고기 길이, 잡은 마릿수</p>
									</div>
								</div>
							</li>
							<li class="fishinfolayout">
