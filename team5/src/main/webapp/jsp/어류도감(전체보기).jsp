...
<div class="main-content">	
 ...
 <ul class="tabs group">
    <li>
           <a class="tabOne switch activeTab" href="<c:url value = "/jsp/어류도감(전체보기).jsp"/>">전체보기</a>
    </li>
    <li>
            <a class="tabTwo switch" href="<c:url value = "/jsp/어류도감(바다고기).jsp"/>">바다고기</a>
    </li>
    <li>
             <a class="tabThree switch" href="<c:url value = "/jsp/어류도감(민물고기).jsp"/>">민물고기</a>
      </li>
...
<li class ="fishinfolayout">
  	<div class = "fishinfoline">
  		...
  		<div class = "fishimg">
  		<img src = "<c:url value = "/resources/godonga1.png"/>" width = "185" height = "150" alt = "이미지파일이어딨지?">
  		</div>
  				<div class = "just">
