					...
					<form id="widget-form" class="widget-post__form" name="form"
						...
						<div class="widget-post__fishcatch " id="fish-kind">
							...
							<label for="search">출조지역:</label> 
								<input type="text" id="mapserach" placeholder="예)거제도" class="widget-post___input widget-post--search search--location" id="address"> 
...
<!-- 어종 검색 자동완성 script -->
	...
	<script>
	function $("#mapserach").click(function(){
		if($("#mapserach").val()== ''){
		alter("fdjskljk")
		}
	});
