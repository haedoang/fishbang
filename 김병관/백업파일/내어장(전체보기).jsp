...
<div class="main-content">	
 ...
 <ul class="tabs group">
    <li>
           <a class="tabOne switch activeTab" href="#">내 어장</a>
    </li>
    <li>
           <a class="tabTwo switch" href="#">잡은 바다고기</a>
    </li>
     <li>
           <a class="tabTwo switch" href="#">잡은 민물고기</a>
    </li>
...
<li class ="fishinfolayout">
  	<div class = "fishinfoline">
  		...
  		<div class = "fishimg">
  		<img src = "<c:url value = "/resources/fish1.png"/>" width = "185" height = "150" alt = "이미지파일이어딨지?">
  		</div>
  				<div class = "just">
